...
filename = 'CARTA.xlsx'
path_to_md_output = '/Users/colmconnaughton/Warwick/DSSG/msforms/CARTA-md/'
path_to_pdf_output = '/Users/colmconnaughton/Warwick/DSSG/msforms/CARTA-pdfs/'
...
tags = ['START_TIME', 'COMPLETE_TIME', 'EMAIL', 'NAME', 'FORENAME', 'SURNAME', 'PREFERRED_NAME',
        'EMAIL2', 'PHONE', 'ADDRESS', 'COUNTRY', 'SHORT_INTRO', 'GENDER',  'UNIVERSITY', 'UNI_COUNTRY',
